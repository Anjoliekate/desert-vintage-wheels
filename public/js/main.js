...
(function (html) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function nextImage(event) {
      ...
      const imageList = button.parentElement.querySelector(".image-list");
      console.log("imageList:", imageList);
      const images = imageList.querySelectorAll(".listing-image");
      console.log("images:", images);
      let currentImageIndex = Array.from(images).findIndex(
